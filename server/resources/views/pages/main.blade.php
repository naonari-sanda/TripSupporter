        ...
        <div class="row">
            ...
            <div class="col d-flex justify-content-center ">
                <div class="card" style="width: 18rem; margin-bottom: 5rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title font-weight-bolder">{{ $country->name }}</h5>
                        <div class="d-flex">
                            <star-rating v-bind:increment="0.5" v-bind:rating="{{ $country->reviews->avg('recommend') ?? '0' }}" text-class="custom-text" v-bind:read-only="true" v-bind:show-rating="false" v-bind:star-size="25" active-color="#ff4742"></star-rating>
                            <p class="custom-text d-flex align-items-center mb-0 ml-1">{{ $country->reviews->avg('recommend') ?? '' }}</p>
                        </div>

                        <p class="card-text mt-2">{{ Str::limit($country->detail, $limit = 80, $end = '...') }}</p>
                        <div class="d-flex">
