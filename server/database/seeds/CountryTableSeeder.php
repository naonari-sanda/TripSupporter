    ...
    public function run()
    {
        DB::table('countries')->insert([
            ...
            [
                ...
                'gdp' => '543',
                'happiness' => '6086',
                'detail' => '銀の国、アルゼンチンは、278万400km2、南北3800kmで国土面積世界第8位。首都ブエノス・アイレスは、ラ・プラタ川沿いに位置する大都市。そこからチリ国境へかけての西側は、ワインの里メンドーサや保養地のコルドバといった気候のいいエリアが広がる。ボリビア国境にかけての北側は、灼熱の太陽がむき出しの山肌を照らす乾燥地帯。その中心サルタは、アルゼンチンフォルクローレのメッカだ。そしてパタゴニア地方は、人よりも動物が多いエリア。世界に残された数少ない大自然を実感できるフィールドだ。',
                'comment' => 'latin,wh'
            ],
            [
                'name' => '日本',
            ...
            [
                ...
                'gdp' => '2147',
                'happiness' => '6892',
                'detail' => '世界遺産の宝庫、イタリア。芸術、文化、観光、食、ショッピングなど魅力満載で、陽気にホスピタリティあふれる人々が迎えてくれる国だ。人気の都市といえば、現代と古代が調和された町ローマ。ルネッサンス都市フィレンツェ。水の都であり旅情あふれるヴェネツィア。ショッピングも楽しい現代イタリアを代表する活気あるミラノ。どの街を訪れてもそれぞれに違う表情を与えてくれる。生活を楽しむイタリア人のなかで過ごすイタリアの旅は、私たちにも生きる喜びと新しい力を与えてくれるに違いない。',
                'comment' => 'eu,wh'
            ],
            [
                'name' => '英国',
                ...
                'gdp' => '2950',
                'happiness' => '7054',
                'detail' => 'イギリスといえば、バラの花咲くイングリッシュ・ガーデン、歴史と伝統を残したマナー・ハウス、そして優雅な午後の紅茶を思い浮かべる人も多いだろう。カントリー・サイドには多くの自然が残り、ゆったりとした時の流れを感じとることができる。しかし、イギリスには、ロンドンという刺激的な大都市もある。あらゆる文化の最先端と伝統が混在するロンドンは、カントリー・サイドとは一味違った魅力が凝縮されている。何度訪れても飽きることがない、さまざまな顔を持っている国だ。',
                'comment' => 'eu,wh'
            ],
            [
                'name' => 'ロシア連邦',
            ...
            [
                ...
                'gdp' => '350',
                'happiness' => '4722',
                'detail' => 'アフリカ大陸の最南端、豊かな自然と資源を有する。沿岸部はケープタウンを中心に、いくつもの見どころや観光地が続く。内陸部は、クルーガー国立公園を筆頭に数多くの国立公園や自然保護区が見られる。大自然の美しさを各地に残しつつ、ダイヤや金の発見により経済的にもアフリカ大陸最大の国となった南アフリカ。アフリカで最もアフリカらしくない国ともいわれるが、白人による国の中枢支配の長い歴史もあり、アフリカともヨーロッパとも違う独自の文化を育み、新しい時代を歩んでいる。',
                'comment' => 'africa'
            ],
            [
                'name' => 'オーストラリア連邦',
                ...
                'gdp' => '1442',
                'happiness' => '7228',
                'detail' => '日本の約21倍の面積を持つ広大な国オーストラリア。グレート・バリア・リーフ、エアーズ・ロックなど世界に類を見ない壮大な自然景観、カンガルーやコアラなどのユニークな動物たち。街に目を向けると、オリンピックを成功させ活気溢れるシドニー、英国風のたたずまいを見せるメルボルン、一年中温暖で「世界でもっとも住みやすい」といわれるパース。自然も都市も丸ごと楽しめ、ここは旅の魅力がいっぱい詰まった「旅大陸」だ！',
                'comment' => 'ocea,wh'
            ],
            [
                'name' => 'ニュージーランド',
